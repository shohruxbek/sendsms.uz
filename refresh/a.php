...
<html lang="en">
    <head>
        ...
        <title>asdfhg - Admin Panel </title>
 ...
 <div class='row'>
										<div class='col-md-6 col-sm-12' >
											<form id="notification_form" method="POST" action="1615906154.php" class="form-horizontal form-label-left">
												<input type="hidden" id="hidden" name="hidden" required="" value="1615906154" aria-required="true">
											
												<div class="form-group">
													<div class="col-md-6 col-sm-6 col-xs-12">
														<button type="submit" id="submit_btn" name="submit" class="btn btn-primary">Sms xabarlarni yuborish</button>
													</div>
												</div>
											</form>
										</div>
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
									...
									<table class='table-striped' id='questions'
                                        data-toggle="table"
                                        data-url="get-list.php?table=1615906154"
