                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>SMS bazasini<small> Tozalash/ko'rish</small></h2>
                                ...
                                <div class="x_content">
									...
									<table class='table-striped' id='questions'
                                        data-toggle="table"
                                        data-url="get-list.php?table=sender"
										...
										<thead>
											<tr>
                                                ...
                                                <th data-field="image" data-sortable="true">Nomer bazasi</th>
                                                <th data-field="question" data-sortable="true">Nomer soni</th>
                                                <th data-field="optiona" data-sortable="true">Natijasi</th>
                                                <th data-field="operate" data-sortable="true" data-events="actionEvents">Amal</th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
